...
import 'package:flutter_html/extensions/text_extensions.dart';
...
class Style {
  ...
  static Map<String, Style> fromThemeData(ThemeData theme) => {
        'h1': Style.fromTextStyle(
            getTextStyle(theme.textTheme, 'displayLarge', 'headline1')),
        'h2': Style.fromTextStyle(
            getTextStyle(theme.textTheme, 'displayMedium', 'headline2')),
        'h3': Style.fromTextStyle(
            getTextStyle(theme.textTheme, 'displaySmall', 'headline3')),
        'h4': Style.fromTextStyle(
            getTextStyle(theme.textTheme, 'headlineMedium', 'headline4')),
        'h5': Style.fromTextStyle(
            getTextStyle(theme.textTheme, 'headlineSmall', 'headline5')),
        'h6': Style.fromTextStyle(
            getTextStyle(theme.textTheme, 'titleLarge', 'headline6')),
        'body': Style.fromTextStyle(
            getTextStyle(theme.textTheme, 'bodyMedium', 'bodyText2')),
      };

  static TextStyle getTextStyle(
      TextTheme textTheme, String newStyle, String oldStyle) {
    // Check for the presence of the newer style first, then fall back to the old style.
    var newStyleGetter = textTheme.getProperty(newStyle);
    var oldStyleGetter = textTheme.getProperty(oldStyle);

    return newStyleGetter ?? oldStyleGetter ?? TextStyle();
  }
