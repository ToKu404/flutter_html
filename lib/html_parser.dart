...
class HtmlParser extends StatelessWidget {
  ...
  static StyledElement lexDomTree(
    ...
    StyledElement tree = StyledElement(
      ...
      style: Style.fromTextStyle(Style.getTextStyle(
          Theme.of(context).textTheme, 'bodyMedium', 'bodyText2')),
    );
    ...
    if (node is dom.Element) {
      ...
      if (STYLED_ELEMENTS.contains(node.localName)) {
        ...
        return parseReplacedElement(
            node, children, navigationDelegateForIframe);
          ...
          child: Row(
            ...
            children: [
              tree.style.listStylePosition == ListStylePosition.OUTSIDE
                  ? Padding(
                      padding: tree.style.padding?.nonNegative ??
                          EdgeInsets.only(
